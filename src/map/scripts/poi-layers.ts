...
export function addPOILayers(map: maplibregl.Map): void {
  ...
  const poiFilter: maplibregl.FilterSpecification = [
    ...
    [
      ...
      [
        "any",
        ["all", [">=", ["get", "importance_score"], 0.8], [">=", ["zoom"], 8]],
        ["all", [">=", ["get", "importance_score"], 0.7], [">=", ["zoom"], 9]],
        ["all", [">=", ["get", "importance_score"], 0.6], [">=", ["zoom"], 10]],
        ["all", [">=", ["get", "importance_score"], 0.5], [">=", ["zoom"], 12]],
        ["all", [">=", ["zoom"], 14]],
      ],
    ],
    ...
    [
      ...
      [
        ...
        [
          "all",
          [">=", ["get", "importance_score"], 0.85],
          [">=", ["zoom"], 11],
        ],
        ["all", [">=", ["get", "importance_score"], 0.8], [">=", ["zoom"], 12]],
        [
          "all",
